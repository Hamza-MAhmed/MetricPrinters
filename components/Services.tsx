...
import tshirt from '../public/tshirts.png'
import billbook from '../public/billbooks.png'
import boxes from '../public/boxes.png'
import booksImg from '../public/books.png'
import files from '../public/files.png'
import panaflex from '../public/panaflex.png'
import signboard from '../public/signboard.png'
import card from '../public/visitingcard.png'
...
const services = [
  { name: 'Visiting Cards', desc: 'Premium business cards in matte, gloss, UV, or soft-touch finishes.', src: card, alt: 'Premium creative business cards' },
  { name: 'Panaflex Banners', desc: 'Large-format flex banners for shops and outdoor advertising.', src: panaflex, alt: 'Large outdoor signage' },
  { name: 'Sign Boards', desc: 'Durable indoor and outdoor signboards for your office or shop front.', src: signboard, alt: 'Commercial signboard' },
  // { name: 'Stickers & Labels', desc: 'Die-cut stickers, product labels, and waterproof labels.', src: IMG.stationery, alt: 'Printed labels and stickers' },
  { name: 'Bill Books & Forms', desc: 'Numbered bill books, invoice pads, and custom office forms.', src: billbook, alt: 'Professional bill books' },
  { name: 'T-Shirts & Uniforms', desc: 'Screen printing and heat transfer on t-shirts and uniforms.', src: tshirt, alt: 'Printed t-shirts' },
  // { name: 'Caps & Hats', desc: 'Branded caps for staff, events, or promotional giveaways.', src: IMG.caps, alt: 'Custom printed caps' },
  // { name: 'Keychains', desc: 'Custom printed keychains for corporate gifts and branding.', src: IMG.keychains, alt: 'Promotional items' },
  // { name: 'Branded Pens', desc: 'Logo-printed pens — a cost-effective promotional item.', src: IMG.pens, alt: 'Branded office pens' },
  { name: 'Books & Catalogues', desc: 'Product catalogues, company profiles, and brochures.', src: booksImg, alt: 'Printed book catalogues' },
  { name: 'Files & Folders', desc: 'Branded presentation folders for a professional corporate look.', src: files, alt: 'Corporate files and folders' },
  { name: 'Packaging Boxes', desc: 'Custom printed boxes for products, gifting, and e-commerce.', src: boxes, alt: 'Branded packaging boxes' },
  // { name: 'Screen Printing', desc: 'High-quality screen printing on fabric, paper, and hard surfaces.', src: IMG.screen, alt: 'Screen printing work' },
  { name: 'Customized Everything', desc: "If it can be printed, we can get it done. Just ask us.", src: custom, alt: 'Various printed products' },
]
